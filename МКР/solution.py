...
За розрахунком стандартного відхилення, найбільш стабільним кліматичним регіоном 
у даному масиві виявився Київ (std=10.106), тоді як клімат Одеси показав найбільші температурні коливання (std=10.194).
